...
**Codex adversarial gate**: {enabled|disabled}; if enabled, completion also requires `codex-adversarial-report.md` containing `ADVERSARIAL PASS`
...
When `--codex-verify` is enabled, add:
